...
class EndMenu:
    ...
    def _update_button(self):
        """Recalculate button position based on screen size."""
        screen_width, screen_height = self.screen.get_size()
        center_x = screen_width // 2
    ...
    def draw(self, player_scores):
        """Draw the end menu with the leaderboard and button."""
        # Update button position in case of screen resize
        self._update_button()
    ...
    def handle_click(self, pos, game_state):
        """Handle button click for returning to main menu."""
