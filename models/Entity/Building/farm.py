...
class Farm(Building):
    ...
    def __init__(self,id_gen,cell_Y, cell_X, position, team,representation = 'F', sq_size = 2, hp = 100, cost = {"gold":0,"wood":175,"food":0}, build_time = 50, storage_capacity = FARM_CAPACITY, resource_indicator = "food"):
