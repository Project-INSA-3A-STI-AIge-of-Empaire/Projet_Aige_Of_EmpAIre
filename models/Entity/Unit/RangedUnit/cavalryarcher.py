...
class CavalryArcher(RangedUnit):
    ...
    def __init__(self, cell_Y, cell_X, position, team, representation = 'c', hp = 50, cost = {"gold":60,"wood":40,"food":0}, training_time = 34, speed = 1.4, attack = 6, attack_speed = 0.9, _range = 5.5, _projectile_type = "fpa"):
