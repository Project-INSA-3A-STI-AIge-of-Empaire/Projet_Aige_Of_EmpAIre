...
class SpearMan(RangedUnit):
    ...
    def __init__(self, cell_Y, cell_X, position, team, representation = 'sm', hp = 35, cost = {"gold":0,"wood":35,"food":25}, training_time = 32, speed = 1, attack = 3, attack_speed = 0.8, _range = 5, _projectile_type = "fps"):
